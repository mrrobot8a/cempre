            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form method="post" id="FrmHojaDeVida" onsubmit="return agregarNuevo()">
                                    <div class="row">
                                        <div class="col-lg-2">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" id="fechaU" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">Programa</label>
                                        <div class="col-md-9">
                                            <input class="form-control" id="programaU" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" id="primerapellidoU" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">SEGUNDO APELLIDO</label>
                                        <div class="col-md-9">
                                            <input class="form-control" id="segundoapellidoU" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">NOMBRES</label>
                                        <div class="col-md-9">
                                            <input class="form-control" id="nombresU" disabled>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="control-label col-md-3">CÉDULA DE CIUDADANÍA</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="cedulaU" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" id="fechaNaciminetoU" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" id="estadoCivilU" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">DIRECCIÓN ACTUAL</label>
                                        <div class="col-md-9">
                                            <input class="form-control" id="direccionU" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">TELÉFONO</label>
                                        <div class="col-md-9">
                                            <input class="form-control" id="telefonoU" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">EPS ACTUAL - TRAER DOCUMENTO EN
                                            FISICO</label>
                                        <div class="col-md-9">
                                            <input class="form-control" id="epsU" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">CORREO ELECTRÓNICO</label>
                                        <div class="col-md-9">
                                            <input class="form-control" id="correoElectronicoU" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">CIUDAD</label>
                                        <div class="col-md-9">
                                            <input class="form-control" id="ciudadU" disabled>
                                        </div>
                                    </div>

                                    <label for="">2.- ESTUDIOS REALIZADOS <br>NIVEL SECUNDARIO</label>

                                    <hr>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">INSTITUCIÓN</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="instituto_01U" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="titulo_01U" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">FECHA</label>
                                        <div class="col-md-9">
                                            <input class="form-control" id="fecha_01U" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">INSTITUCIÓN</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="instituto_02U" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">TÍTULO</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="titulo_02U" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">FECHA</label>
                                        <div class="col-md-9">
                                            <input class="form-control" id="fecha_02U" disabled>
                                        </div>
                                    </div>
                                    <br>
                                    <hr>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control " id="ingles_01U" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label class="control-label">Comprende al escuchar</label>
                                                    <input class="form-control " id="ingles_02U" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <label class="control-label">Habla</label>
                                                    <input class="form-control" id="ingles_03U" disabled>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="ingles_04U" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="idiomas">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <input class="form-control " id="aleman_01U" disabled>

                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <input class="form-control " id="aleman_02U" disabled>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <input class="form-control" id="aleman_03U" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <input class="form-control" id="aleman_04U" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="idiomas">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <input class="form-control " id="frances_01U" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <input class="form-control " id="frances_02U" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <input class="form-control" id="frances_03U" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <input class="form-control" id="frances_04U" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="idiomas">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <input class="form-control " id="otros_01U" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <input class="form-control " id="otros_02U" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <input class="form-control" id="otros_03U" disabled>
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <input class="form-control" id="otros_04U" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <hr>
                                    <div class="col-md-12">
                                        <textarea id="apartado_03U" class="form-control" rows="4" disabled></textarea>
                                    </div>
                                    <br>
                                    <label for="">4.- CONOCIMIENTO Y/O PRÁCTICA DE INFORMÁTICA QUE POSEE</label>
                                    <hr>
                                    <div class="col-md-12">
                                        <textarea id="apartado_04U" class="form-control" rows="6" disabled></textarea>
                                    </div>
                                    <br>
                                    <label for="">5.- SEMINARIOS Y CURSOS ASISTIDOS (TEMA - INSTITUCIÓN -
                                        FECHA)</label>
                                    <hr>
                                    <div class="col-md-12">
                                        <textarea id="apartado_05U" class="form-control" rows="6" disabled></textarea>
                                    </div>
                                    ...
                                    <hr>
                                    <div class="col-md-12">
                                        <textarea id="apartado_06U" class="form-control" rows="4" disabled></textarea>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="entidad_01U" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">CARGO</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="cargo_01U" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">FUNCIONES DESEMPEÑADAS</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="funcion_01U" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">DURACIÓN - FECHA</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="duracion_01U" disabled>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">ENTIDAD </label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="entidad_02U" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">CARGO</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="cargo_02U" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">FUNCIONES DESEMPEÑADAS</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="funcion_02U" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">DURACIÓN - FECHA</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="duracion_02U" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <hr>
                                    <div class="col-md-12">
                                        <textarea id="apartado_08U" class="form-control" rows="4" disabled></textarea>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form method="post" id="FrmHojaDeVidaU">
                                    ...
                                    <label class="control-label col-md-3">Programa</label>
                                    <div class="col-md-9">
                                        <select class="form-control" id="programaX" name="programaX" required="required">
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-3">NOMBRES</label>
                                    <div class="col-md-9">
                                        <input class="form-control" id="nombresX" name="nombresX"
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-3">ESTADO CIVIL</label>
                                    <div class="col-md-9">
                                            <select class="form-control" id="estadoCivilX" name="estadoCivilX" required="required">
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-3">EPS ACTUAL - TRAER DOCUMENTO EN FISICO</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-3">CORREO ELECTRÓNICO</label>
                                    <div class="col-md-9">
                                        <input class="form-control" id="correoElectronicoX" name="correoElectronicoX"
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-3">INSTITUCIÓN</label>
                                    <div class="col-md-9">
                                            <input type="text" class="form-control" id="instituto_01X" name="instituto_01X"
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-3">INSTITUCIÓN</label>
                                    <div class="col-md-9">
                                            <input type="text" class="form-control" id="instituto_02X" name="instituto_02X"
                                                placeholder="*Ingrese institución " pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,60}" 
                                                required="required" minlength="15" maxlength="60" title="Solamente se admiten caracteres">
                                    </div>
                                </div>
                               ...
                               <hr>   
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-3">DURACIÓN - FECHA</label>
                                    <div class="col-md-9">
                                            <input type="text" class="form-control" id="duracion_01X" name="duracion_01X"
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-3">DURACIÓN - FECHA</label>
                                    <div class="col-md-9">
                                            <input type="text" class="form-control" id="duracion_02X" name="duracion_02X"
                                                placeholder="Ingrese duración y fecha"  minlength="15" maxlength="30" >
                                    </div>
                                </div>
