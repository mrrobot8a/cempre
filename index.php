        ...
        <div class="login-box">
            <form class="login-form" action="" method="post">
                ...
                <div class="alert"><?php echo isset($alert) ? $alert : ''; ?></div>
                    <input class="form-control" type="text" id="usuario" name="usuario" minlength="4" maxlength="40"
                        placeholder="*Ingrese Usuario" required="required">
                </div>
                <div class="form-group">
                   
                    <input class="form-control" type="password" id="clave" name="clave" minlength="3" maxlength="20"
                ...
                <div class="form-group">
                    <div class="utility">
                        ...
                        <p class="semibold-text mb-2"><a href="#" data-toggle="flip">Se te olvidó tu contraseña ?</a>
                        </p>
                    </div>
                </div>
                <div class="form-group btn-container">
                    <button class="btn btn-primary btn-block" type="submit" id="btnlogion"><i
                            class="fa fa-sign-in fa-lg fa-fw"></i>INGRESAR</button>
                </div>
            </form>
            <form class="forget-form" action="index.html">
                <h3 class="login-head">Recuperar constraseña</h3>
                <div class="form-group">
                ...
                <div class="form-group btn-container">
                    <button class="btn btn-primary btn-block"><i
                            class="fa fa-unlock fa-lg fa-fw"></i>RESTABLECER</button>
                </div>
